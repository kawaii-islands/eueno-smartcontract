...
pub fn deserialize_verifying_key(vk_le: &[u8]) -> Result<ArkVerifyingKey<Bls12_381>, String> {
    let mut pointer = 0;
...
pub fn deserialize_proof(proof_le: &[u8]) -> Result<ArkProof<Bls12_381>, String> {
    let mut pointer = 0;
